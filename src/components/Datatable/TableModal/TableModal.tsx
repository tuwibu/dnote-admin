...
const TableModal: React.FC<TableProps> = (props) => {
  const { tableKey, tableColumns, api, addComponent, actionComponent, childId } = props

  const { state, setState, reload, columns, setColumns, searchColumns } = useTableModal()
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await api.getAllChild(childId, {
